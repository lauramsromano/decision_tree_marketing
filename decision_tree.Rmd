...
# Colunas com p-valor NAN:

# frequencia_meses <- table(base$month)
# frequencia_dias_da_semama <- table(base$day_of_week)

# print(frequencia_dias_da_semama)
...
for (i in nome_colunas_cat) {
  frequencia_i <- table(base[[i]])
  barplot(frequencia_i, main = paste("Gráfico de Barras de", i), xlab = i, ylab = "Frequência")
}
